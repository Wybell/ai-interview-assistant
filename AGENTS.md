...
- Production Compose now passes the custom provider's external endpoint, API key, reasoning effort, and response-storage variables into the backend container; the tracked example contains placeholders only.
